...
namespace Com.Baidu.Location {
	...
	public partial interface ILLSInterface : IJavaObject {
		...
		double Version {
			...
			[Register ("getVersion", "()D", "GetGetVersionHandler:Com.Baidu.Location.ILLSInterfaceInvoker, BaiDuMapBinding")] get;
		}
		...
		[Register ("onBind", "(Landroid/content/Intent;)Landroid/os/IBinder;", "GetOnBind_Landroid_content_Intent_Handler:Com.Baidu.Location.ILLSInterfaceInvoker, BaiDuMapBinding")]
		...
		[Register ("onCreate", "(Landroid/content/Context;)V", "GetOnCreate_Landroid_content_Context_Handler:Com.Baidu.Location.ILLSInterfaceInvoker, BaiDuMapBinding")]
		...
		[Register ("onDestroy", "()V", "GetOnDestroyHandler:Com.Baidu.Location.ILLSInterfaceInvoker, BaiDuMapBinding")]
		void OnDestroy ();
		...
		[Register ("onStartCommand", "(Landroid/content/Intent;II)I", "GetOnStartCommand_Landroid_content_Intent_IIHandler:Com.Baidu.Location.ILLSInterfaceInvoker, BaiDuMapBinding")]
		...
		[Register ("onUnBind", "(Landroid/content/Intent;)Z", "GetOnUnBind_Landroid_content_Intent_Handler:Com.Baidu.Location.ILLSInterfaceInvoker, BaiDuMapBinding")]
