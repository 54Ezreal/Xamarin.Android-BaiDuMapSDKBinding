...
namespace Com.Baidu.Platform.Comapi.Util {
	...
	public partial interface ISysUpdateObserver : IJavaObject {
		...
		[Register ("init", "()V", "GetInitHandler:Com.Baidu.Platform.Comapi.Util.ISysUpdateObserverInvoker, BaiDuMapBinding")]
		void Init ();
		...
		[Register ("updateNetworkInfo", "(Landroid/content/Context;)V", "GetUpdateNetworkInfo_Landroid_content_Context_Handler:Com.Baidu.Platform.Comapi.Util.ISysUpdateObserverInvoker, BaiDuMapBinding")]
		...
		[Register ("updateNetworkProxy", "(Landroid/content/Context;)V", "GetUpdateNetworkProxy_Landroid_content_Context_Handler:Com.Baidu.Platform.Comapi.Util.ISysUpdateObserverInvoker, BaiDuMapBinding")]
		...
		[Register ("updatePhoneInfo", "()V", "GetUpdatePhoneInfoHandler:Com.Baidu.Platform.Comapi.Util.ISysUpdateObserverInvoker, BaiDuMapBinding")]
