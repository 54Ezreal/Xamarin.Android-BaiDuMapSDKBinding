...
namespace Com.Baidu.Mapapi.Map {
	...
	public sealed partial class TextureMapView : global::Android.Views.ViewGroup {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/baidu/mapapi/map/TextureMapView", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (TextureMapView); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (TextureMapView)) {
					SetHandle (
