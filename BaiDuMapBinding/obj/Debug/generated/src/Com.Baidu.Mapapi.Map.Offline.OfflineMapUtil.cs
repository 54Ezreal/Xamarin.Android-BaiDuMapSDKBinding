...
namespace Com.Baidu.Mapapi.Map.Offline {
	...
	public partial class OfflineMapUtil : global::Java.Lang.Object {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/baidu/mapapi/map/offline/OfflineMapUtil", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (OfflineMapUtil); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (OfflineMapUtil)) {
					SetHandle (
